...
public class Mirafit_weight_Bars_Pom 
{
	...
	@FindBy (xpath = "(//span[@class='caret'])[3]") private WebElement Weight_Bars;
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[27]") private WebElement Medicine_Balls;
