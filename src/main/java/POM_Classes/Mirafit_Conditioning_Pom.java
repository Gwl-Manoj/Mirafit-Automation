...
public class Mirafit_Conditioning_Pom
{
	@FindBy (xpath = "(//span[@class='caret'])[5]") private WebElement Conditioning;
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[36]") private WebElement Exercise_Mats;
	...
	public Mirafit_Conditioning_Pom(WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void Moveto_Conditioning(WebDriver driver) throws InterruptedException
	{
		Actions act = new Actions(driver);
		act.moveToElement(Conditioning).perform();
		Exercise_Mats.click();
