...
public class Mirafit_ParallelBars_Pom 
{
	...
	@FindBy(xpath = "//a[@title='Notify me when this product is in stock']") private WebElement Stock_Status;
	...
	public void Click_Choice(WebDriver driver)
	{	
		Select choice = new Select(Choice);
		choice.selectByValue("5438");
		boolean stock_status = Stock_Status.isDisplayed();
