...
public class Mirafit_GymStorage_Pom 
{

	@FindBy (xpath = "(//span[@class='caret'])[6]") private WebElement Gym_Storage;
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[49]") private WebElement Plate_Storage;
	...
	@FindBy(xpath = "(//a[@class='product-item-link'])[1]") private WebElement ViewDetails;
	...
	public Mirafit_GymStorage_Pom(WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void Moveto_Gym_Storage(WebDriver driver) throws InterruptedException
	{
		Actions act = new Actions(driver);
		act.moveToElement(Gym_Storage).perform();
		Plate_Storage.click();
