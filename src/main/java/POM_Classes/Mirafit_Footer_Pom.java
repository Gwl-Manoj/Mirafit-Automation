...
{  
	...
	@FindBy(xpath = "//a[@href='https://preprod.mirafit.co.uk/buyers-guides']") private WebElement buyers_guides;
	...
	@FindBy (xpath = "(//a[@href='https://preprod.mirafit.co.uk/strength-equipment.html'])[3]") private WebElement Strength_Equipment;
	@FindBy (xpath = "//a[@href='https://preprod.mirafit.co.uk/weights-bars.html']") private WebElement Weights_Bars;
	@FindBy (xpath = "(//a[@href='https://preprod.mirafit.co.uk/conditioning.html'])[3]") private WebElement Conditioning;
	@FindBy (xpath = "(//a[@href='https://preprod.mirafit.co.uk/storage.html'])[3]") private WebElement Gym_Storage;
	@FindBy (xpath = "(//a[@href='https://preprod.mirafit.co.uk/accessories.html'])[3]") private WebElement Accessories;
	@FindBy (xpath = "(//a[@href='https://preprod.mirafit.co.uk/packages.html'])[3]") private WebElement Packages;
	@FindBy (xpath = "(//a[@href='https://preprod.mirafit.co.uk/shop-by-sport.html'])[3]") private WebElement Shop_by_sport;
...
//  Company_Pom
	public void click_About_US(WebDriver driver) throws InterruptedException
	{
		...
		String actualurl = "https://preprod.mirafit.co.uk/about-us";
		Reporter.log("The URL for About_US is "+URL,true);
		if(URL.equalsIgnoreCase(actualurl))
		{
			Reporter.log("The actual and expected URL is same for "+Text, true);
		}
		else
		{
			Reporter.log("The actual and expected URL is different for "+Text, true);
		}
	...
	public void click_Athletes(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/meet-our-ambassadors";
	...
	public void click_Blog(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/blog";
	...
	public void click_Careers(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/careers";
	...
	public void click_FAQs(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/faqs";
	...
	public void click_Contact_US(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/contact";
	...
	public void click_FAQs_Help(WebDriver driver) throws InterruptedException
	{
	...
	public void click_Delivery(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/delivery";
	...
	public void click_Returns(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/returns";
	...
	public void click_Finance(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/finance";
	...
	public void click_Privacy_Policy(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/privacy-policy";
	...
	public void click_Terms_Conditions(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/terms-and-conditions";
	...
	public void click_Product_Help_Centre(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/product-help-centre";
	...
	public void click_buyers_guides(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/buyers-guides";
	...
	public void click_Tik_Tok(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://www.tiktok.com/@mirafitofficial";
	...
	public void click_Strength_Equipment(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/strength-equipment.html";
	...
	public void click_Weights_Bars(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/weights-and-bars.html";
	...
	public void click_Conditioning(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/conditioning.html";
	...
	public void click_Gym_Storage(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/storage.html";
	...
	public void click_Accessories(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/accessories.html";
	...
	public void click_Packages(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/packages.html";
	...
	public void click_Shop_by_sport(WebDriver driver) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String URL = driver.getCurrentUrl();
		String actualurl = "https://preprod.mirafit.co.uk/shop-by-sport.html";
	...
	public void Footer_Shop_Option(WebDriver driver) throws InterruptedException
	{
		
		click_Strength_Equipment(driver);
		
		click_Weights_Bars(driver);
		
		click_Conditioning(driver);
		
		click_Gym_Storage(driver);
		
		click_Accessories(driver);
		
		click_Packages(driver);
		
		click_Shop_by_sport(driver);
		
	
	}
	
	public void Footer_Company_Option(WebDriver driver) throws InterruptedException
	{
		click_About_US(driver);
		
		click_Athletes(driver);
		
		click_Blog(driver);
		
		click_Careers(driver);
		
		click_FAQs(driver);
		
	}
	
	public void Footer_Help_Option(WebDriver driver) throws InterruptedException
	{
		click_Contact_US(driver);
		
		click_FAQs(driver);
		
		click_Delivery(driver);
		
		click_Returns(driver);
		
		click_Finance(driver);
		
		click_Privacy_Policy(driver);
		
		click_Terms_Conditions(driver);
			
		click_Product_Help_Centre(driver);
		
		click_buyers_guides(driver);
		
	}
	
	public void Footer_Share_Option(WebDriver driver) throws InterruptedException
	{
		click_Facebook(driver);
		
		click_Instagram(driver);
		
		click_Youtube(driver);
		
		click_Tik_Tok(driver);
	}
