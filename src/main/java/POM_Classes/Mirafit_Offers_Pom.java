...
public class Mirafit_Offers_Pom
{
	@FindBy (xpath = "(//span[@class='caret'])[9]") private WebElement Offers;
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[62]") private WebElement Strength_Equipements;
	...
	public Mirafit_Offers_Pom(WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void Moveto_Offers(WebDriver driver) throws InterruptedException
	{
		Actions act = new Actions(driver);
		act.moveToElement(Offers).perform();
		Strength_Equipements.click();
