...
public class Mirafit_ShopbySports_Pom
{

	@FindBy (xpath = "(//span[@class='caret'])[8]") private WebElement ShopbySports;
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[58]") private WebElement Climbing;
	...
	public Mirafit_ShopbySports_Pom(WebDriver driver)
	{
	...
	public void Moveto_ShopbySports(WebDriver driver) throws InterruptedException
	{
		Actions act = new Actions(driver);
		act.moveToElement(ShopbySports).perform();
		Climbing.click();
