...
public class Mirafit_Conditioning_Test extends Mirafit_BaseClass_Pre_Production
{
	...
	@Test
	public void Conditioning() throws InterruptedException, EncryptedDocumentException, IOException
	{
		login.login();
