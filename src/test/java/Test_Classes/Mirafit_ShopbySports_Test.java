...
import POM_Classes.Mirafit_ShopbySports_Pom;

public class Mirafit_ShopbySports_Test extends Mirafit_BaseClass_Pre_Production 
{

	int TCID;
	Login_Pre_Production_Pom login;
	Logout_Pom logout;
	Mirafit_ShopbySports_Pom Shop_By_Sport;
	...
	public void OpenBrowser() throws InterruptedException
	{
		...
		Shop_By_Sport = new Mirafit_ShopbySports_Pom(driver);
	...
	@Test
	public void ShopbySports() throws InterruptedException, EncryptedDocumentException, IOException
	{
		login.login();
		
		Shop_By_Sport.Moveto_ShopbySports(driver);
